  ...
  <style>
    * { margin: 0; padding: 0; box-sizing: border-box; }
    :root {
      ...
      --text-soft: #5e5e5e;
      --text-light: #8e8e8e;
      --accent-wechat: #4A90D9;
      --accent-intent: #4A90D9;
      --accent-wechat-bg: #EDF4FC;
      --accent-intent-bg: #EDF4FC;
      --accent-btn: rgba(74,144,217,0.5);
      ...
      --radius-sm: 8px;
      --radius-xs: 6px;
      --wechat-gradient: linear-gradient(135deg, #B3D9F7 0%, #7BC0F0 50%, #4A90D9 100%);
    ...
    body.dark-mode {
      ...
      --text-soft: #a0a0a0;
      --text-light: #6b6b6b;
      --accent-wechat: #6CB4EE;
      --accent-intent: #6CB4EE;
      --accent-wechat-bg: #1A2D3D;
      --accent-intent-bg: #1A2D3D;
      --accent-btn: rgba(108,180,238,0.4);
      ...
      --wechat-gradient: linear-gradient(135deg, #152B3D 0%, #1E4058 50%, #2A6080 100%);
    ...
    .icon-simple { background: rgba(255,255,255,0.88); border: 1px solid rgba(0,0,0,0.1); color: #191919; font-weight: 600; backdrop-filter: blur(10px); -webkit-backdrop-filter: blur(10px); min-width: 32px; height: 28px; padding: 0 8px; border-radius: var(--radius-xs); display: flex; align-items: center; justify-content: center; cursor: pointer; font-size: 0.72rem; transition: all 0.2s cubic-bezier(0.34,1.56,0.64,1); user-select: none; font-weight: 600; position: relative; white-space: nowrap; }
