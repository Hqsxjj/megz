...
<dict>
    ...
    if (path === '/api/export' && request.method === 'POST') {
      ...
      if (type === 'single_client') {
        ...
        text += '> 电话: ' + (client.phone || '—') + '\n';
        text += '> 单位: ' + (client.company || '—') + ' | 公积金: ' + (client.fund || '—') + '\n';
        text += '> 沟通: ' + ((client.note || '') ? client.note.replace(/\n/g, ' ') : '—') + '\n';
        text += '> 跟进: ' + ((client.followUp || '') ? client.followUp.replace(/\n/g, ' ') : '—') + '\n';
        text += '> 年龄:' + (client.age || '—') + ' | ' + (client.maritalStatus || '—') + ' | 深户:' + (client.isShenzhenHukou || '—') + ' | ' + (client.education || '—') + ' | 房产:' + (client.property || '—') + '\n';
        text += '> 社保基数:' + (client.socialSecurity || '—') + ' | 月均工资:' + (client.avgSalary || '—') + ' | 近2年个税:' + (client.tax2yr || '—') + ' | 代发银行:' + (client.salaryBank || '—') + '\n';
        text += '> 信贷负债:' + (client.bankDebt || '—') + ' | 信用卡负债:' + (client.creditCardDebt || '—') + ' | 近3月查询:' + (client.query3m || '—') + '次 | 网贷笔数:' + (client.onlineLoanCount || '—') + '\n';
        text += '> 需求: ' + ((client.demand || '') ? client.demand.replace(/\n/g, ' ') : '—') + '\n';
        text += '> 资金用途: ' + ((client.fundUsage || '') ? client.fundUsage.replace(/\n/g, ' ') : '—') + '\n';
      ...
      if (type === 'all_clients') {
        ...
        const itemFormatter = (c) => {
          ...
          itemText += '> 电话: ' + (c.phone || '—') + '\n';
          itemText += '> 单位: ' + (c.company || '—') + ' | 公积金: ' + (c.fund || '—') + '\n';
          itemText += '> 沟通: ' + ((c.note || '') ? c.note.replace(/\n/g, ' ') : '—') + '\n';
          itemText += '> 跟进: ' + ((c.followUp || '') ? c.followUp.replace(/\n/g, ' ') : '—') + '\n';
          itemText += '> 年龄:' + (c.age || '—') + ' | ' + (c.maritalStatus || '—') + ' | 深户:' + (c.isShenzhenHukou || '—') + ' | ' + (c.education || '—') + ' | 房产:' + (c.property || '—') + '\n';
          itemText += '> 社保基数:' + (c.socialSecurity || '—') + ' | 月均工资:' + (c.avgSalary || '—') + ' | 近2年个税:' + (c.tax2yr || '—') + ' | 代发银行:' + (c.salaryBank || '—') + '\n';
          itemText += '> 信贷负债:' + (c.bankDebt || '—') + ' | 信用卡负债:' + (c.creditCardDebt || '—') + ' | 近3月查询:' + (c.query3m || '—') + '次 | 网贷笔数:' + (c.onlineLoanCount || '—') + '\n';
          itemText += '> 需求: ' + ((c.demand || '') ? c.demand.replace(/\n/g, ' ') : '—') + '\n';
          itemText += '> 资金用途: ' + ((c.fundUsage || '') ? c.fundUsage.replace(/\n/g, ' ') : '—') + '\n';
      ...
      if (type === 'all_clients_solo') {
        ...
        const buildText = (c) => {
          ...
          text += '> 电话: ' + (c.phone || '—') + '\n';
          text += '> 单位: ' + (c.company || '—') + ' | 公积金: ' + (c.fund || '—') + '\n';
          text += '> 沟通: ' + ((c.note || '') ? c.note.replace(/\n/g, ' ') : '—') + '\n';
          text += '> 跟进: ' + ((c.followUp || '') ? c.followUp.replace(/\n/g, ' ') : '—') + '\n';
          text += '> 年龄:' + (c.age || '—') + ' | ' + (c.maritalStatus || '—') + ' | 深户:' + (c.isShenzhenHukou || '—') + ' | ' + (c.education || '—') + ' | 房产:' + (c.property || '—') + '\n';
          text += '> 社保基数:' + (c.socialSecurity || '—') + ' | 月均工资:' + (c.avgSalary || '—') + ' | 近2年个税:' + (c.tax2yr || '—') + ' | 代发银行:' + (c.salaryBank || '—') + '\n';
          text += '> 信贷负债:' + (c.bankDebt || '—') + ' | 信用卡负债:' + (c.creditCardDebt || '—') + ' | 近3月查询:' + (c.query3m || '—') + '次 | 网贷笔数:' + (c.onlineLoanCount || '—') + '\n';
          text += '> 需求: ' + ((c.demand || '') ? c.demand.replace(/\n/g, ' ') : '—') + '\n';
          text += '> 资金用途: ' + ((c.fundUsage || '') ? c.fundUsage.replace(/\n/g, ' ') : '—') + '\n';
