...
<dict>
    ...
    if (path === '/api/export' && request.method === 'POST') {
      ...
      if (type === 'single_client') {
        ...
        text += '> 客户大致需求：' + ((client.demand || '') ? client.demand.replace(/\n/g, ' ') : '—') + '\n';
        text += '> 资金用途和时间：' + ((client.fundUsage || '') ? client.fundUsage.replace(/\n/g, ' ') : '—') + '\n';
        text += '> 沟通记录：' + ((client.note || '') ? client.note.replace(/\n/g, ' ') : '—') + '\n';
        text += '> 跟进情况：' + ((client.followUp || '') ? client.followUp.replace(/\n/g, ' ') : '—') + '\n';
      ...
      if (type === 'all_clients') {
        ...
        const itemFormatter = (c) => {
          ...
          itemText += '> 客户大致需求：' + ((c.demand || '') ? c.demand.replace(/\n/g, ' ') : '—') + '\n';
          itemText += '> 资金用途和时间：' + ((c.fundUsage || '') ? c.fundUsage.replace(/\n/g, ' ') : '—') + '\n';
          itemText += '> 沟通记录：' + ((c.note || '') ? c.note.replace(/\n/g, ' ') : '—') + '\n';
          itemText += '> 跟进情况：' + ((c.followUp || '') ? c.followUp.replace(/\n/g, ' ') : '—') + '\n';
      ...
      if (type === 'all_clients_solo') {
        ...
        const buildText = (c) => {
          ...
          text += '> 客户大致需求：' + ((c.demand || '') ? c.demand.replace(/\n/g, ' ') : '—') + '\n';
          text += '> 资金用途和时间：' + ((c.fundUsage || '') ? c.fundUsage.replace(/\n/g, ' ') : '—') + '\n';
          text += '> 沟通记录：' + ((c.note || '') ? c.note.replace(/\n/g, ' ') : '—') + '\n';
          text += '> 跟进情况：' + ((c.followUp || '') ? c.followUp.replace(/\n/g, ' ') : '—') + '\n';
